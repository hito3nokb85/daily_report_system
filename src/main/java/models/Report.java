...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_REP_GET_FOLEE,
            query = JpaConst.Q_REP_GET_FOLEE_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_FOLEE,
            query = JpaConst.Q_REP_COUNT_FOLEE_DEF)
})

@Getter //全てのクラスフィールドについてgetterを自動生成する(Lombok)
@Setter //全てにクラスフィールドについてsetterを自動生成する(Lombok)
